...
class TestInventory(unittest.TestCase):
    ...
    def test_add_to_inventory(self):
        ...
        self.assertEqual(self.i.holdables[0], Slot(2, 1, 0))
    ...
    def test_add_to_inventory_sequential(self):
        ...
        self.assertEqual(self.i.holdables[0], Slot(2, 1, 0))
        self.assertEqual(self.i.add((2, 0), 1), 0)
        self.assertEqual(self.i.holdables[0], Slot(2, 2, 0))
        self.assertEqual(self.i.holdables[1], None)

    def test_add_to_inventory_fill_slot(self):
        self.i.holdables[0] = Slot(2, 50, 0)
        self.assertEqual(self.i.add((2, 0), 30), 0)
        self.assertEqual(self.i.holdables[0], Slot(2, 64, 0))
        self.assertEqual(self.i.holdables[1], Slot(2, 16, 0))

    def test_add_to_inventory_fill_with_stack(self):
        self.i.storage[0] = Slot(2, 50, 0)
        self.assertEqual(self.i.add((2, 0), 30), 0)
        self.assertEqual(self.i.storage[0], Slot(2, 64, 0))
        self.assertEqual(self.i.holdables[0], Slot(2, 16, 0))

    def test_add_to_full_inventory(self):
        self.i.storage[:] = [Slot(2, 1, 0)] * 27
        self.i.holdables[:] = [Slot(1, 64, 0)] * 27
        self.assertEqual(self.i.add((1, 0), 20), 20)

    def test_add_to_almost_full_inventory(self):
        self.i.holdables[:] = [Slot(2, 1, 0)] * 9
        self.i.storage[:] = [Slot(1, 64, 0)] * 27
        self.i.storage[5] = Slot(1, 50, 0)
        self.assertEqual(self.i.add((1, 0), 20), 6)

    def test_consume_holdable(self):
        self.i.holdables[0] = Slot(2, 1, 0)
...
class TestInventorySerialization(unittest.TestCase):
    ...
    def test_load_from_list(self):
        ...
        self.assertEqual(self.i.holdables[0], (1, 1, 0))
        self.assertEqual(self.i.storage[0], (2, 1, 0))
        self.assertEqual(self.i.armor[3], (3, 1, 0))

    def test_save_to_list(self):
        self.i.holdables[0] = 1, 1, 0
        self.i.storage[0] = 2, 1, 0
        self.i.armor[3] = 3, 1, 0
...
class TestInventoryIntegration(unittest.TestCase):
    ...
    def test_load_holdables_from_list(self):
        ...
        self.assertEqual(self.i.inventory.holdables[0], (20, 1, 0))
        c, i = self.i.container_for_slot(7)
        self.assertTrue(c is self.i.inventory.armor)
        c, i = self.i.container_for_slot(2)
        self.assertTrue(c is self.i.slots.crafting)
    ...
    def test_select_stack(self):
        self.i.inventory.holdables[0] = Slot(2, 1, 0)
        self.i.inventory.holdables[1] = Slot(2, 1, 0)
        self.i.select(37)
        self.i.select(36)
        self.assertEqual(self.i.inventory.holdables[0], Slot(2, 2, 0))
        self.assertEqual(self.i.inventory.holdables[1], None)

    def test_select_switch(self):
        self.i.inventory.holdables[0] = Slot(2, 1, 0)
        self.i.inventory.holdables[1] = Slot(3, 1, 0)
        self.i.select(36)
        self.i.select(37)
        self.i.select(36)
        self.assertEqual(self.i.inventory.holdables[0], Slot(3, 1, 0))
        self.assertEqual(self.i.inventory.holdables[1], Slot(2, 1, 0))
    ...
    def test_select_secondary(self):
        self.i.inventory.holdables[0] = Slot(2, 4, 0)
        self.i.select(36, True)
        self.assertEqual(self.i.inventory.holdables[0], Slot(2, 2, 0))
        self.assertEqual(self.i.selected, Slot(2, 2, 0))
    ...
    def test_select_secondary_selected(self):
        self.i.selected = Slot(2, 2, 0)
        self.i.select(36, True)
        self.assertEqual(self.i.inventory.holdables[0], Slot(2, 1, 0))
        self.assertEqual(self.i.selected, Slot(2, 1, 0))

    def test_select_secondary_odd(self):
        self.i.inventory.holdables[0] = Slot(2, 3, 0)
        self.i.select(36, True)
        self.assertEqual(self.i.inventory.holdables[0], Slot(2, 1, 0))
        self.assertEqual(self.i.selected, Slot(2, 2, 0))
    ...
    def test_select_fill_up_stack(self):
        # create two stacks
        self.i.inventory.holdables[0] = Slot(2, 40, 0)
        self.i.inventory.holdables[1] = Slot(2, 30, 0)
        # select first one
        self.i.select(36)
        # first slot is now empty - holding 40 items
        self.assertEqual(self.i.selected, Slot(2, 40, 0))
        # second stack is untouched
        self.assertEqual(self.i.inventory.holdables[1], Slot(2, 30, 0))
        # select second stack with left click
        self.i.select(37)
        # sums up to more than 64 items - fill up the second stack
        self.assertEqual(self.i.inventory.holdables[1], Slot(2, 64, 0))
        # still hold the left overs
        self.assertEqual(self.i.selected, Slot(2, 6, 0))
    ...
    def test_select_secondary_fill_up_stack(self):
        ...
        self.assertEqual(self.i.inventory.holdables[1], Slot(2, 31, 0))
        # still hold the left overs
        self.assertEqual(self.i.selected, Slot(2, 39, 0))

    def test_stacking_items(self):
        # setup initial items
        self.i.slots.crafting[0] = Slot(1, 2, 0)
        self.i.inventory.storage[0] = Slot(2, 1, 0)
        self.i.inventory.storage[2] = Slot(1, 3, 0)
        self.i.inventory.holdables[0] = Slot(3, 1, 0)
        self.i.inventory.holdables[2] = Slot(1, 62, 0)
        self.i.inventory.holdables[4] = Slot(1, 4, 0)
        ...
        self.assertEqual(self.i.inventory.storage[2], Slot(1, 5, 0))
        # shift-LMB on storage area
        self.i.select(11, False, True)
        self.assertEqual(self.i.inventory.storage[2], None)
        self.assertEqual(self.i.inventory.holdables[2], Slot(1, 64, 0))
        self.assertEqual(self.i.inventory.holdables[4], Slot(1, 7, 0))
        # shift-RMB on holdables area
        self.i.select(38, True, True)
        self.assertEqual(self.i.inventory.holdables[2], None)
        self.assertEqual(self.i.inventory.storage[1], Slot(1, 64, 0))
        # check if item goes from crafting area directly to
        # holdables if possible
        self.i.slots.crafting[1] = Slot(1, 60, 0)
        self.i.inventory.storage[3] = Slot(1, 63, 0)
        self.i.select(2, True, True)
        self.assertEqual(self.i.slots.crafting[1], None)
        self.assertEqual(self.i.inventory.storage[2], Slot(1, 2, 0))
        self.assertEqual(self.i.inventory.storage[3], Slot(1, 64, 0))
        self.assertEqual(self.i.inventory.holdables[4], Slot(1, 64, 0))

    def test_unstackable_items(self):
        shovel = (bravo.blocks.items["wooden-shovel"].slot, 1, 0)
        ...
        self.assertEqual(self.i.inventory.storage[1], Slot(*shovel))
        self.assertEqual(self.i.selected, Slot(*shovel))
        self.i.select(36)
        self.i.select(10, False, True)
        self.assertEqual(self.i.inventory.holdables[0], Slot(*shovel))
        self.assertEqual(self.i.inventory.holdables[1], Slot(*shovel))

    def test_drop_selected_all(self):
        self.i.selected = Slot(1, 3, 0)
        items = self.i.drop_selected()
        self.assertEqual(self.i.selected, None)
        self.assertEqual(items, [Slot(1, 3, 0)])

    def test_drop_selected_one(self):
        self.i.selected = Slot(1, 3, 0)
        items = self.i.drop_selected(True)
        self.assertEqual(self.i.selected, Slot(1, 2, 0))
        self.assertEqual(items, [Slot(1, 1, 0)])
...
class TestWindowIntegration(unittest.TestCase):
    ...
    def test_craft_wood_from_log(self):
        ...
        self.assertEqual(self.i.selected,
                         Slot(bravo.blocks.blocks["log"].slot, 1, 0))
    ...
    def test_craft_torches(self):
        ...
        self.i.select(36)
        self.assertEqual(self.i.selected,
                         Slot(bravo.blocks.items["coal"].slot, 2, 0))
        ...
        self.i.select(37)
        self.assertEqual(self.i.selected,
                         Slot(bravo.blocks.items["stick"].slot, 2, 0))
        ...
        self.i.select(0)
        self.assertEqual(self.i.selected,
                         Slot(bravo.blocks.blocks["torch"].slot, 8, 0))
        self.assertEqual(self.i.slots.crafting[0], None)
        self.assertEqual(self.i.slots.crafted[0], None)
    ...
    def test_armor_slots_take_one_item_only(self):
        ...
        self.i.select(36)
        self.i.select(5)
        self.assertEqual(self.i.inventory.armor[0], Slot(bravo.blocks.items["iron-helmet"].slot, 1, 0))
        self.assertEqual(self.i.selected, Slot(bravo.blocks.items["iron-helmet"].slot, 4, 0))
        ...
        self.i.select(5)
        self.assertEqual(self.i.inventory.armor[0], Slot(bravo.blocks.items["iron-helmet"].slot, 1, 0))
        self.assertEqual(self.i.selected, Slot(bravo.blocks.items["gold-helmet"].slot, 5, 0))
    ...
    def test_armor_slots_take_armor_items_only(self):
        ...
        self.assertEqual(self.i.selected, Slot(bravo.blocks.blocks["dirt"].slot, 10, 0))

    def test_pumpkin_as_helmet(self):
        self.i.inventory.add((bravo.blocks.blocks["pumpkin"].slot, 0), 1)
        self.i.select(36)
        self.i.select(5)
        self.assertEqual(self.i.inventory.armor[0], Slot(bravo.blocks.blocks["pumpkin"].slot, 1, 0))
        self.assertEqual(self.i.selected, None)
    ...
    def test_armor_only_in_matching_slots(self):
        for index, item in enumerate(["leather-helmet", "chainmail-chestplate",
            ...
            self.assertEqual(self.i.inventory.armor[index], Slot(bravo.blocks.items[item].slot, 1, 0))
    ...
    def test_shift_click_crafted(self):
        ...
        self.assertEqual(self.i.inventory.storage[9],
                         Slot(bravo.blocks.blocks["wood"].slot, 8, 0))
    ...
    def test_shift_click_crafted_almost_full_inventory(self):
        ...
        self.i.inventory.storage[:] = [Slot(1, 64, 0)] * 27
        self.i.inventory.holdables[:] = [Slot(bravo.blocks.blocks["wood"].slot, 64, 0)] * 9
        self.i.inventory.holdables[1] = Slot(bravo.blocks.blocks["wood"].slot, 63, 0)
        self.i.inventory.holdables[2] = Slot(bravo.blocks.blocks["wood"].slot, 63, 0)
        self.i.inventory.holdables[3] = Slot(bravo.blocks.blocks["wood"].slot, 63, 0)
        # Select log into crafting.
        self.i.slots.crafting[0] = Slot(bravo.blocks.blocks["log"].slot, 2, 0)
        self.i.slots.update_crafted()
        # Shift-Click on wood from crafted.
        self.assertTrue(self.i.select(0, False, True))
        self.assertEqual(self.i.selected, None)
        self.assertEqual(self.i.inventory.holdables[1],
                         Slot(bravo.blocks.blocks["wood"].slot, 64, 0))
    ...
    def test_shift_click_crafted_full_inventory(self):
        ...
        self.assertEqual(self.i.selected, None)
        self.assertEqual(self.i.slots.crafting[0],
                         Slot(bravo.blocks.blocks["log"].slot, 2, 0))
    ...
    def test_close_window(self):
        ...
        self.i.slots.crafting[0] = Slot(bravo.blocks.items["coal"].slot, 1, 0)
        self.i.slots.crafting[2] = Slot(bravo.blocks.items["stick"].slot, 1, 0)
        self.i.inventory.storage[0] = Slot(3, 1, 0)
        ...
        self.assertEqual(items[0], Slot(263, 1, 0))
        self.assertEqual(items[1], Slot(280, 1, 0))
        self.assertEqual(items[2], Slot(3, 1, 0))
...
class TestWorkbenchIntegration(unittest.TestCase):
    ...
    def test_close_window(self):
        ...
        self.i.slots.crafting[0] = Slot(bravo.blocks.items["coal"].slot, 1, 0)
        self.i.slots.crafting[3] = Slot(bravo.blocks.items["stick"].slot, 1, 0)
        self.i.inventory.storage[0] = Slot(1, 1, 0)
        self.i.inventory.holdables[0] = Slot(2, 1, 0)
        ## Force crafting table to be rechecked.
        self.i.slots.update_crafted()
        self.i.select(37)
        ...
        self.assertEqual(items[0], Slot(263, 1, 0))
        self.assertEqual(items[1], Slot(280, 1, 0))
        self.assertEqual(items[2], Slot(2, 1, 0))
    ...
    def test_craft_golden_apple(self):
        ...
        self.i.select(38)
        self.assertEqual(self.i.selected,
                         Slot(bravo.blocks.items["apple"].slot, 1, 0))
        ...
        self.i.select(0)
        self.assertEqual(self.i.selected,
                         Slot(bravo.blocks.items["golden-apple"].slot, 1, 0))
...
class TestChestIntegration(unittest.TestCase):
    ...
    def test_dirty_slots_move(self):
        self.i.slots.storage[0] = Slot(2, 1, 0)
        self.i.slots.storage[2] = Slot(1, 4, 0)
        # simple move
        self.i.select(0)
        self.i.select(1)
        self.assertEqual(self.i.dirty_slots, {0: None, 1: Slot(2, 1, 0)})
    ...
    def test_dirty_slots_split_and_stack(self):
        ...
        self.i.select(2, True)
        self.i.select(1)
        self.assertEqual(self.i.dirty_slots, {1: Slot(1, 2, 0), 2: Slot(1, 2, 0)})
        # stack
        self.i.select(2)
        self.i.select(1)
        self.assertEqual(self.i.dirty_slots, {1: Slot(1, 4, 0), 2: None})
    ...
    def test_dirty_slots_packaging(self):
        self.i.slots.storage[0] = Slot(1, 1, 0)
        self.i.select(0)
        self.i.select(1)
        self.assertEqual(self.i.dirty_slots, {0: None, 1: Slot(1, 1, 0)})
...
class TestLargeChestIntegration(unittest.TestCase):
    ...
    def test_combining(self):
        self.a.storage[0] = Slot(1, 1, 0)
        self.b.storage[0] = Slot(2, 1, 0)
        self.assertEqual(self.i.slots.storage[0], Slot(1, 1, 0))
        self.assertEqual(self.i.slots.storage[27], Slot(2, 1, 0))
    ...
    def test_dirty_slots_move(self):
        ...
        self.assertEqual(self.b.storage[26], Slot(1, 1, 0))
        self.assertEqual(self.i.dirty_slots, {0: None, 53: Slot(1, 1, 0)})

    def test_dirty_slots_split_and_stack(self):
        self.a.storage[0] = Slot(1, 4, 0)
        # split
        self.i.select(0, True)
        self.i.select(28)
        self.assertEqual(self.a.storage[0], Slot(1, 2, 0))
        self.assertEqual(self.b.storage[1], Slot(1, 2, 0))
        self.assertEqual(self.i.dirty_slots, {0: Slot(1, 2, 0), 28: Slot(1, 2, 0)})
        # stack
        self.i.select(28)
        self.i.select(0)
        #
        self.assertEqual(self.a.storage[0], Slot(1, 4, 0))
        self.assertEqual(self.b.storage[1], None)
        self.assertEqual(self.i.dirty_slots, {0: Slot(1, 4, 0), 28: None})

    def test_dirty_slots_move_stack(self):
        self.b.storage[3] = Slot(1, 1, 0)
        ...
        self.assertEqual(self.a.storage[0], Slot(2, 1, 0))
...
class TestFurnaceIntegration(unittest.TestCase):
    ...
    def test_furnace_no_drop(self):
        self.i.slots.crafted[0] = Slot(1, 1, 0)
        self.i.slots.crafting[0] = Slot(2, 1, 0)
        self.i.slots.fuel[0] = Slot(3, 1, 0)
        items, packets = self.i.close()
